...
import com.example.ok.atmfinder.Activities.Banks;
import com.example.ok.atmfinder.Activities.MapsActivity;
import com.example.ok.atmfinder.Activities.Places;
import com.example.ok.atmfinder.Models.AtmModel;
import com.example.ok.atmfinder.R;

import java.util.ArrayList;

import static com.example.ok.atmfinder.Models.LAT.AKary_sheben_LAT;
import static com.example.ok.atmfinder.Models.LAT.Ahly_menof_LAT;
import static com.example.ok.atmfinder.Models.LAT.Ahly_qysna_LAT;
import static com.example.ok.atmfinder.Models.LAT.Ahly_sab3_LAT;
import static com.example.ok.atmfinder.Models.LAT.Ahly_sheben_LAT;
import static com.example.ok.atmfinder.Models.LAT.Alex_qysna_LAT;
import static com.example.ok.atmfinder.Models.LAT.Alex_sheben_LAT;
import static com.example.ok.atmfinder.Models.LAT.CIB_menof_LAT;
import static com.example.ok.atmfinder.Models.LAT.CIB_sheben_LAT;
import static com.example.ok.atmfinder.Models.LAT.Cairo_menof_LAT;
import static com.example.ok.atmfinder.Models.LAT.Cairo_sab3_LAT;
import static com.example.ok.atmfinder.Models.LAT.Cairo_sheben_LAT;
import static com.example.ok.atmfinder.Models.LAT.Eslamx_menof_LAT;
import static com.example.ok.atmfinder.Models.LAT.Eslamx_sheben_LAT;
import static com.example.ok.atmfinder.Models.LAT.masr_menof_LAT;
import static com.example.ok.atmfinder.Models.LAT.masr_qysna_LAT;
import static com.example.ok.atmfinder.Models.LAT.masr_sheben_LAT;
import static com.example.ok.atmfinder.Models.NameBank.AKary_sheben;
import static com.example.ok.atmfinder.Models.NameBank.Ahly_menof;
import static com.example.ok.atmfinder.Models.NameBank.Ahly_qysna;
import static com.example.ok.atmfinder.Models.NameBank.Ahly_sab3;
...
import static com.example.ok.atmfinder.Models.NameBank.Cairo_sheben;
import static com.example.ok.atmfinder.Models.NameBank.Eslamx_menof;
import static com.example.ok.atmfinder.Models.NameBank.Eslamx_sheben;
import static com.example.ok.atmfinder.Models.NameBank.masr_menof;
import static com.example.ok.atmfinder.Models.NameBank.masr_qysna;
import static com.example.ok.atmfinder.Models.NameBank.masr_sheben;
import static com.example.ok.atmfinder.Models.lNG.AKary_sheben_LNG;
import static com.example.ok.atmfinder.Models.lNG.Ahly_menof_LNG;
import static com.example.ok.atmfinder.Models.lNG.Ahly_qysna_LNG;
import static com.example.ok.atmfinder.Models.lNG.Ahly_sab3_LNG;
import static com.example.ok.atmfinder.Models.lNG.Ahly_sheben_LNG;
import static com.example.ok.atmfinder.Models.lNG.Alex_qysna_LNG;
import static com.example.ok.atmfinder.Models.lNG.Alex_sheben_LNG;
import static com.example.ok.atmfinder.Models.lNG.CIB_menof_LNG;
import static com.example.ok.atmfinder.Models.lNG.CIB_sheben_LNG;
import static com.example.ok.atmfinder.Models.lNG.Cairo_menof_LNG;
import static com.example.ok.atmfinder.Models.lNG.Cairo_sab3_LNG;
import static com.example.ok.atmfinder.Models.lNG.Cairo_sheben_LNG;
import static com.example.ok.atmfinder.Models.lNG.Eslamx_menof_LNG;
import static com.example.ok.atmfinder.Models.lNG.Eslamx_sheben_LNG;
import static com.example.ok.atmfinder.Models.lNG.masr_menof_LNG;
import static com.example.ok.atmfinder.Models.lNG.masr_qysna_LNG;
import static com.example.ok.atmfinder.Models.lNG.masr_sheben_LNG;
